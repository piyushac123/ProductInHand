...
//        }
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6"><h1 style="font-family: 'Aclonica';font-weight:bold;">Shopkeeper History</h1></div>
            </div>
            <?php
            ...
            ?>
                <div class="row trans-row" style="margin-bottom:10px;" id="<?php echo 'row_'.$i; ?>">
                    ...
                    <div class="col-lg-3"><h4><div class="hist-Text"><b>Username : </b><?php echo $arrFrom[$i][1];?></div><div class="hist-Text"><b>Total Cost : </b><?php echo "Rs. ".$arrList[$i][9]; ?></div></h4></div>
